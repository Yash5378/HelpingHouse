...
export default function DonorSignupForm({ onBack }) {
    ...
    return (
        ...
        >
            ...
            >
                {/* decorative circles */}
                <div style={{ position: "absolute", top: -60, right: -60, width: 220, height: 220, borderRadius: "50%", background: "rgba(59,130,246,0.15)" }} />
                <div style={{ position: "absolute", bottom: -40, left: -40, width: 160, height: 160, borderRadius: "50%", background: "rgba(29,78,216,0.2)" }} />

                <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 48 }}>
                        <div style={{ width: 44, height: 44, background: "linear-gradient(135deg,#3b82f6,#1d4ed8)", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 12px rgba(59,130,246,0.5)" }}>
                            <HeartFilled style={{ color: "white", fontSize: 20 }} />
                        </div>
                        <Text style={{ color: "white", fontWeight: 700, fontSize: 18 }}>Helping House</Text>
                    </div>

                    <Title level={2} style={{ color: "white", margin: "0 0 12px", fontWeight: 800, fontSize: 28 }}>
                ...
                <div>
                    {[
                        ...
                        <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                            ...
                            <Text style={{ color: "#cbd5e1", fontSize: 13 }}>{item.text}</Text>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div
                style={{
                    ...
                    width: "100%",
                    maxWidth: 480,
                    boxShadow: "0 20px 60px rgba(59,130,246,0.12), 0 4px 20px rgba(0,0,0,0.06)",
                    position: "relative",
                }}
            >
                {/* Back button */}
                ...
                >
                    <Form.Item
                        name="name"
                        label={<Text style={{ color: "#374151", fontWeight: 600, fontSize: 13 }}>User Name</Text>}
                        rules={[
                    ...
                    <Form.Item
                        name="email"
                        label={<Text style={{ color: "#374151", fontWeight: 600, fontSize: 13 }}>Email address</Text>}
                        rules={[
                    ...
                    {passwordValue && (
                        <div style={{ marginTop: -12, marginBottom: 16 }}>
                            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                                <Text style={{ fontSize: 11, color: "#94a3b8" }}>Password strength</Text>
                    ...
                    <Text style={{ color: "#94a3b8", fontSize: 12, display: "block", marginBottom: 16, lineHeight: 1.5 }}>
                    ...
                    {/* Terms */}
                    <Text style={{ color: "#94a3b8", fontSize: 12, display: "block", marginBottom: 20, lineHeight: 1.6 }}>
                ...
                <Text style={{ display: "block", textAlign: "center", marginTop: 20, color: "#64748b", fontSize: 13 }}>
