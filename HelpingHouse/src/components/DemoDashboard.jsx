...
const menuItems = [
    ...
    { key: "2", icon: <HomeOutlined />, label: "Organization" },
    { key: "3", icon: <TeamOutlined />, label: "Personnel" },
    { key: "4", icon: <FileTextOutlined />, label: "Documents" },
    { key: "5", icon: <HeartOutlined />, label: "Donations" },
    { key: "6", icon: <CalendarOutlined />, label: "Events" },
        ...
        <Layout style={{ minHeight: "100vh", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
            ...
            >
                ...
                >
                    ...
                    {!collapsed && (
                        <div>
                            <Text style={{ color: "white", fontWeight: 700, fontSize: 13, display: "block", lineHeight: 1.2 }}>
                                Community
                            </Text>
                            <Text style={{ color: "#93c5fd", fontSize: 11 }}>Lighthouse</Text>
                        </div>
                    )}
                </div>
                ...
                <div style={{ position: "absolute", bottom: 16, left: 0, right: 0, padding: "0 16px" }}>
                    {!collapsed && (
                        ...
                        >
                            <Text style={{ color: "#93c5fd", fontSize: 12, display: "block", marginBottom: 6 }}>
                                Monthly Goal
                            </Text>
                            <Progress
                                percent={72}
                                ...
                                size="small"
                            />
                            <Text style={{ color: "white", fontSize: 11, marginTop: 4, display: "block" }}>
                                $36,000 of $50,000
                            </Text>
                        </Card>
                    )}
                    ...
                    <Space size={12}>
                        ...
                        <Dropdown menu={{ items: userMenuItems }} trigger={["click"]}>
                            <Space style={{ cursor: "pointer" }}>
                                <Avatar src="https://randomuser.me/api/portraits/women/44.jpg" size={36} />
                                <Text style={{ color: "#374151", fontWeight: 500 }}>Sarah Chen</Text>
                                <DownOutlined style={{ fontSize: 11, color: "#9ca3af" }} />
                            </Space>
                        </Dropdown>
                    </Space>
                </Header> */}
                ...
                >
                    ...
                    <div style={{ padding: "72px 32px 40px" }}>
                        ...
                        <Row gutter={[16, 16]} style={{ marginBottom: 28 }}>
                            {[
                                { title: "Total Volunteers", value: 1248, icon: <TeamOutlined />, color: "#3b82f6", bg: "#eff6ff" },
                                { title: "Families Helped", value: 5430, icon: <HeartFilled />, color: "#ef4444", bg: "#fef2f2" },
                                { title: "Events This Year", value: 84, icon: <CalendarOutlined />, color: "#10b981", bg: "#f0fdf4" },
                                { title: "Funds Raised", value: "$128K", icon: <TrophyOutlined />, color: "#f59e0b", bg: "#fffbeb" },
                            ].map((s, i) => (
                                <Col xs={24} sm={12} lg={6} key={i}>
                                    ...
                                    >
                                        <Space>
                                            ...
                                            <div>
                                                <Text style={{ color: "#64748b", fontSize: 13 }}>{s.title}</Text>
                                                <Title level={3} style={{ margin: 0, color: "#0f172a", lineHeight: 1.2 }}>
                                                    {s.value}
                                                </Title>
                                            </div>
                                        </Space>
                                        <div style={{ marginTop: 12, display: "flex", alignItems: "center", gap: 4 }}>
                                            ...
                                            <Text style={{ color: "#10b981", fontSize: 12 }}>+12% from last month</Text>
                                        </div>
                                    </Card>
                                </Col>
                            ))}
