...
export default function Signup() {
    ...
    return (
        <Flex align="center" justify="center" className="signup-page" style={{ minHeight: "100vh" }}>
            <div className="signup-container" style={{ maxWidth: 640, width: "100%" }}>
                {!selectedType ? (
                    ...
                    <Flex vertical align="center" className="signup-header">
                        ...
                        <Title level={2} className="auth-title">Who are you joining as?</Title>
                        <Text type="secondary" className="auth-subtitle">
                            Choose the account type that best describes you.
                        </Text>

                        <Flex gap="middle" className="signup-type-grid w-100" style={{ marginTop: 24 }}>
                            {ACCOUNT_TYPES.map((type) => (
                                ...
                                >
                                    ...
                                    <Title level={5} className="signup-type-title">{type.title}</Title>
                                    <Text type="secondary" className="signup-type-desc">{type.description}</Text>
                                </Card>
                            ))}
                        </Flex>
                    ...
                    // Step 2: Show form
                    <Card className="auth-card wide" style={{ maxWidth: 540, margin: "0 auto" }} bordered={false}>
                        {selectedType === "donor" ? (
