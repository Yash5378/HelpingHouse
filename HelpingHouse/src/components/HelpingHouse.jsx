...
const documents = [
  {
    name: "NGO Registration Certificate.pdf",
    type: "pdf",
    size: "2.4 MB",
    date: "Jan 12, 2024",
  },
  {
    name: "Tax Exemption Letter 2024.pdf",
    type: "pdf",
    size: "1.1 MB",
    date: "Feb 03, 2024",
  },
  {
    name: "Annual Impact Report.docx",
    type: "word",
    size: "3.8 MB",
    date: "Mar 20, 2024",
  },
            ...
            <Row gutter={[24, 24]}>
              ...
              <Col xs={24} lg={15}>
                ...
                >
                  ...
                  <Title
                    level={5}
                    style={{ color: "#1e3a5f", marginBottom: 10 }}
                  >
                    About Them
                  </Title>
                  <Paragraph
                  ...
                  <Title
                    level={5}
                    style={{ color: "#1e3a5f", marginBottom: 16 }}
                  >
                    Contact Information
                  </Title>
                  <Row gutter={[16, 12]}>
                        ...
                        {[
                          ...
                          <div key={i} style={{ marginBottom: 18 }}>
                            ...
                            >
                              ...
                              <Text style={{ color: g.color, fontWeight: 600 }}>
                                {g.value}%
                              </Text>
                            </div>
                            <Progress
              ...
              <Col xs={24} lg={9}>
                ...
                >
                  <Title
                    level={5}
                    style={{ margin: "0 0 20px", color: "#1e3a5f" }}
                  >
                    Recent Activity
                  </Title>
                  <Timeline
                    items={[
                      ...
                      },
                      {
                        ...
                        children: (
                          <div>
                            <Text style={{ color: "#374151", fontSize: 13 }}>
                              Event updated: <Text strong>Food Drive</Text>
                            </Text>
                            <Text
                              style={{
                                color: "#94a3b8",
