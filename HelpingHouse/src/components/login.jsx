...
import { Form, Input, Button, Checkbox, Card, Space, Typography, Flex, message } from "antd";
import { MailOutlined, LockOutlined, HomeOutlined, ArrowRightOutlined } from "@ant-design/icons";
import { useNavigate, Link } from "react-router-dom";
import { donerLogin, loginUser, loginWithGoogle } from "../Store/login/loginAction";
...
export default function Login() {
    ...
    return (
        <Flex align="center" justify="center" className="auth-page" style={{ minHeight: "100vh" }}>
            <Card className="auth-card" style={{ maxWidth: 480, width: "100%" }} bordered={false}>
                {/* Logo */}
                ...
                <Text type="secondary" className="auth-subtitle">Sign in to continue your journey of giving.</Text>
