...
import { Form, Input, Button, Card, Typography, Flex, Space, Select } from "antd";
import {
    UserOutlined,
    MailOutlined,
    PhoneOutlined,
...
export default function HelpingHouseSignupForm({ onBack }) {
    ...
    const handleRegister = async (values) => {
        ...
        try {
            ...
            message.success("Account created! Welcome to Helping House 🏠");
    ...
    return (
        <>
            <Button type="link" className="btn-back" onClick={onBack} style={{ padding: 0, marginBottom: 16 }}>
            ...
            <Title level={2} className="auth-title">Create your account</Title>
            <Text type="secondary" className="auth-subtitle">Join our network and connect with donors.</Text>
            ...
            <Form
                ...
                autoComplete="off"
            >
                <Text strong className="form-section-label">Personal information</Text>
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        { pattern: /^[a-zA-Z\s'-]+$/, message: "Name should only contain letters, spaces, hyphens, or apostrophes." }
                    ]}
                >
                ...
                >
                    <Input autoComplete="off" prefix={<MailOutlined />} placeholder="you@example.com" />
                </Form.Item>
                <Form.Item
                    name="website"
                    label="Website"
                ...
                <Form.Item
                    ...
                    label="Ngo Type"
                    rules={[
                        { required: true, message: "Please select your ngo type ." },
                ...
                >
                    <Select placeholder="Select NGO Type">
                        ...
                        <Select.Option value="children_house">Children's House</Select.Option>
                        ...
                        <Select.Option value="disability_support">Disability Support</Select.Option>
                    </Select>
                </Form.Item>
                ...
                <Text strong className="form-section-label" style={{ marginTop: 8 }}>Security</Text>

                <Form.Item name="password" label="Password" rules={passwordRules} hasFeedback>
                    <Input.Password autoComplete="off" prefix={<LockOutlined />} placeholder="Create a strong password" />
                </Form.Item>
                ...
                >
                    <Input.Password autoComplete="off" prefix={<CheckCircleOutlined />} placeholder="Re-enter your password" />
                </Form.Item>

                <Form.Item style={{ marginTop: 24 }}>
                    <Button type="primary" htmlType="submit" className="btn-primary w-100" loading={loading} icon={<ArrowRightOutlined />} iconPosition="end">
                        Create Account
                    </Button>
                </Form.Item>
            </Form>
